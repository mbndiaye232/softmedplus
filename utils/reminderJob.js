  ...
  try {
    ...
    for (const appt of dueRes.rows) {
      ...
      if (appt.consultation_mode === 'TELECONSULTATION' && appt.video_room_slug) {
        // ?lang=fr fait autorite et l'emporte sur la langue memorisee par le
        // telephone du patient ; le fragment ne suffisait pas.
        message += ` Téléconsultation, rejoignez via : https://meet.jit.si/${appt.video_room_slug}?lang=fr`;
      }
